    ...
    <>
      <section className="pt-20 md:pt-40">
        <div className="container mx-auto px-8 lg:flex">
          <div className="mt-20 text-center lg:text-left lg:w-1/2">
            <h1 className="text-4xl lg:text-5xl xl:text-6xl font-bold leading-none">
              Bienvenue sur oAUTH
            </h1>
            <p className="text-xl lg:text-2xl mt-6 font-light">
              Votre site d&apos;authentifications gratuit multifonctionelle sur
              divers platefrome ( GOOGLE, FACEBOOK, GITHUB, ICLOUD, etc...)
            </p>
            <p className="mt-8 md:mt-12 ml-20">
              <div className="flex gap-8">
                <svg
                  ...
                  height="50"
                  fill="currentColor"
                  className="bi bi-speedometer animate-pulse"
                  viewBox="0 0 16 16"
                >
                ...
                <svg
                  ...
                  height="50"
                  fill="currentColor"
                  className="bi bi-shield-lock-fill animate-pulse"
                  viewBox="0 0 16 16"
                >
                  <path
                    fillRule="evenodd"
                ...
                <svg
                  ...
                  height="50"
                  fill="currentColor"
                  className="bi bi-stopwatch-fill animate-pulse"
                  viewBox="0 0 16 16"
                >
