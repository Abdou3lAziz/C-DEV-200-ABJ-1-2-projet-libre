...
function Inscription() {
  ...
  const [dateDeNaissance, setNaissance] = useState("");
  ...
  async function SignupBTN() {
    ...
    const reponses = await fetch("http://localhost:3000/user/",{
      method: "POST",
      headers: {
  ...
  return (
    <>
      <div className="h-screen md:flex">
        <div className="relative overflow-hidden md:flex w-1/2 bg-gradient-to-tr from-cyan-300 to-cyan-500 i justify-around items-center hidden">
          <div>
            <h1 className="text-white font-bold text-4xl font-sans">oAuth</h1>
            <p className="text-white mt-1">
              Votre plateforme d&apos;authentification.
            </p>
            <Link
              to={"/"}
              className="px-4 block w-28 bg-white text-cyan-500 mt-4 py-2 rounded-2xl font-bold mb-2"
            >
              En savoir+
            </Link>
          </div>
        ...
        <div className="flex md:w-1/2 justify-center py-10 items-center bg-white ">
          <form className="p-8 w-5/6 border-4 border-cyan-300 rounded-xl">
            ...
            <div className="flex justify-between gap-3">
              <div className="flex items-center border-2 py-2 px-3 w-1/2 rounded-2xl mb-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="16"
                  height="16"
                  fill="currentColor"
                  className="bi bi-person text-gray-400"
                  viewBox="0 0 16 16"
                >
            ...
            <div className="flex justify-end gap-5 mt-4">
              <div className="flex items-center py-2 px-5 rounded-2xl mb-4">
              ...
              <div className="flex items-center  py-2 px-3 rounded-2xl mb-4">
                <form className="max-w-sm mx-auto">
                  <label
                    htmlFor="countries"
                    className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
            ...
            <button
              onClick={SignupBTN}
              type="button"
              className="block w-full bg-cyan-400 mt-4 py-2 rounded-2xl text-white font-semibold mb-2"
            >
              S&apos;inscrire
            </button>
            <div className="flex justify-between my-5">
              ...
              <div className="px-2 py-2 bg-black rounded-xl">
                <Link
                  to={"/connexion"}
                  className="text-white font-bold text-sm ml-2 hover:text-cyan-500 cursor-pointer"
                >
                  Se connecter
                </Link>
              </div>
            ...
            <div>
              ...
              <div className="flex justify-between my-5">
                ...
                <button className="flex items-center bg-white border border-gray-300 rounded-lg shadow-md max-w-xs px-3 py-2 text-sm font-medium text-gray-800 hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
                  <svg
                    className="h-6 w-6 mr-2"
                    xmlns="http://www.w3.org/2000/svg"
                    // eslint-disable-next-line react/no-unknown-property
